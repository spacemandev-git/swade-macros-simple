...
function fireWeapon(html) {
    ...
    for (let i = 0; i < numShootingDie; i++) {
        ...
        let explodedRoll = newRoll.explode([shootingSkill.die.sides]).total;
        console.log(`Shooting Roll (${i}) After Explosions: `, explodedRoll);
        shootingRolls.push(explodedRoll);
    }
